...
volatile int ship_pos_y = 3;
volatile int ship_pos_z = 3;
volatile int bullet_x = -1, bullet_y = -1;
volatile invader invaders[9];
...
print_special_character(64, lcd_pos(ship_pos,ship_pos_y));
