...
# 13 "../../../Documents/P2/PONG/config_4550.h"
...
# 1 "../../../Documents/P2/PONG/atraso.h"
void atraso_ms(unsigned int valor);

# 116 "../../../Documents/P2/PONG/lcd.h"
void lcd_init(void);
...
# 3 "../../../Documents/P2/PONG/16Keys.h"
char varre_teclas(void);
char trata_teclas(void);

# 12 "../../../Documents/P2/PONG/pong.c"
unsigned char data1[8] = { 0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03};


unsigned char data2[8] = { 0x00, 0x00, 0x0E, 0x0E, 0x0E, 0x0E, 0x00, 0x00 };
...
unsigned char lcd_pos(int line, int col) {
...
volatile int player1_pos = 2;
volatile int player2_pos = 2;
volatile int ball_x = 10, ball_y = 2;
volatile int ball_dir_x = 1, ball_dir_y = 1;
volatile int score1 = 0, score2 = 0;
...
if (ball_y == 1 || ball_y == 4) ball_dir_y = -ball_dir_y;


if (ball_x == 1 && ball_y == player1_pos) ball_dir_x = -ball_dir_x;
if (ball_x == 20 && ball_y == player2_pos) ball_dir_x = -ball_dir_x;
...
print_special_character(64, lcd_pos(player1_pos, 3));
print_special_character(64, lcd_pos(player2_pos, 17));


print_special_character(72, lcd_pos(ball_y, ball_x));

lcd_set_cursor(8, 1);
lcd_str(itoa(score1, buff));
lcd_set_cursor(11, 1);
lcd_str(":");
lcd_set_cursor(13, 0);
lcd_str(itoa(score2, buff));
...
if (score1 == 10 ) {lcd_str("GAME OVER ->RESET"); break;}
if (score2 == 10 ) {lcd_str("GAME OVER ->RESET"); break;}
