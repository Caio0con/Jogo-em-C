...
# 1 "../../../Documents/P2/CHAR_ESP2_TECLAS/caracters_especiais.c"
...
# 13 "../../../Documents/P2/CHAR_ESP2_TECLAS/config_4550.h"
...
# 1 "../../../Documents/P2/CHAR_ESP2_TECLAS/atraso.h"
void atraso_ms(unsigned int valor);

# 116 "../../../Documents/P2/CHAR_ESP2_TECLAS/lcd.h"
void lcd_init(void);
void lcd_cmd(unsigned char val);
void lcd_dat(unsigned char val);
void lcd_str(const char* str);

# 3 "../../../Documents/P2/CHAR_ESP2_TECLAS/16Keys.h"
char varre_teclas(void);
char trata_teclas(void);

# 12 "../../../Documents/P2/CHAR_ESP2_TECLAS/caracters_especiais.c"
unsigned char data1[8] = {4, 14, 21, 4, 4, 4, 4, 0};


unsigned char data2[8] = {0, 4, 4, 4, 4, 21, 14, 4};


unsigned char data3[8] = {0, 10, 31, 31, 31, 14, 4, 0};


unsigned char data4[8] = {4, 14, 14, 4, 0, 31, 10, 0};


unsigned char data5[8] = {0, 0, 10, 0, 31, 14, 4, 0};


unsigned char data6[8] = {0, 4, 14, 21, 4, 14, 4, 0};


unsigned char data7[8] = {4, 6, 5, 4, 5, 6, 4, 0};


unsigned char data8[8] = {4, 12, 20, 4, 20, 12, 4, 0};


unsigned char data9[8] = {4, 14, 16, 12, 2, 30, 4, 0};


unsigned char data10[8] = {12, 18, 12, 10, 21, 9, 22, 0};


unsigned char data11[8] = {14, 17, 17, 14, 0, 0, 0, 0};


unsigned char data12[8] = {4, 20, 8, 4, 2, 17, 17, 14};


unsigned char data13[8] = {4, 6, 5, 4, 4, 4, 4, 0};


unsigned char data14[8] = {4, 4, 4, 4, 5, 6, 4, 0};


unsigned char data15[8] = {4, 12, 20, 4, 4, 4, 4, 0};


unsigned char data16[8] = {4, 4, 4, 4, 20, 12, 4, 0};
...
lcd_cmd(lcd_loc);
lcd_dat((cgram_loc-64)/8);
}



unsigned char lcd_pos(unsigned char line, unsigned char col) {
...
special_char(80, data3);
special_char(88, data4);
special_char(96, data5);
special_char(104, data6);
special_char(112, data7);
special_char(120, data8);

print_special_character(64, lcd_pos(1,1));
print_special_character(72, lcd_pos(2,1));
print_special_character(80, lcd_pos(3,1));
print_special_character(88, lcd_pos(4,1));
print_special_character(96, lcd_pos(1,20));
print_special_character(104, lcd_pos(2,20));
print_special_character(112, lcd_pos(3,20));
print_special_character(120, lcd_pos(4,20));
_delay((unsigned long)((1000)*(48000000/4000.0)));

for (int i=5; i<15; i++){
print_special_character(64, lcd_pos(1,i));
}
_delay((unsigned long)((1000)*(48000000/4000.0)));

for (int i=5; i<15; i++){
print_special_character(120, lcd_pos(2,i));
}
_delay((unsigned long)((1000)*(48000000/4000.0)));

for (int i=5; i<15; i++){
print_special_character(104, lcd_pos(3,i));
}
_delay((unsigned long)((1000)*(48000000/4000.0)));

for (int i=5; i<15; i++){
print_special_character(72, lcd_pos(4,i));
}

_delay((unsigned long)((1000)*(48000000/4000.0)));

lcd_cmd(0x01);
lcd_str("    DIGITE UMA TECLA");
...
switch (tecla_atual) {
case '1': lcd_cmd(0x01); for (int i=5; i<15; i++){
print_special_character(88, lcd_pos(1,i));
}
case '2': lcd_cmd(0x01); print_special_character(88, lcd_pos(1,2)); break;
case '3': lcd_cmd(0x01); print_special_character(88, lcd_pos(1,3)); break;

# 261
case '#': print_special_character(96, lcd_pos(4,17)); break;
case 'D': lcd_cmd(0x01); lcd_str("    DIGITE UMA TECLA"); break;
default: break;
}
} else {
LATD = 0x00;
